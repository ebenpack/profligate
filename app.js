...
(function(exports) {
  ...
  var displayStackInfo = function (cs) {
      return "Function: " + (cs.name + (" (" + (Data_Show.show(Data_Show.showInt)(cs.entries) + (" entries, " + (Data_Show.show(Data_Show.showNumber)(cs.inherited.time) + "%)")))));
  };
  var flameGraph = function (dictMonadEffect) {
      return function (dictMonadAff) {
          return function (prof) {
              var showFlameLegend = function (cs) {
                  var t = Data_Maybe.maybe("")(displayStackInfo)(cs);
              ...
              var $$eval = function (v) {
                  ...
                  if (v instanceof ChangeFlameLegend) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                          ...
                          $17.flameLegend = v.value0;
                          return $17;
                      }))(function (v1) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      });
                  };
                  throw new Error("Failed pattern match at Profligate.FlameGraph (line 94, column 9 - line 94, column 70): " + [ v.constructor.name ]);
              };
              var drawCostCenter = function (offsetLeft) {
                  return function (offsetTop) {
                      return function (cs) {
                          ...
                          var width = Data_Show.show(Data_Show.showNumber)($$Math.floor((cs.inherited.time / 100.0) * totalWidth));
                  ...
                  return function (baseOffset) {
                      return function (cs) {
                          ...
                          var rowHelper = function (v) {
                              return function (acc) {
                                  return Data_Array.cons(drawCostCenter(v.offset)(offsetTop)(v.tree.value))(acc);
                              };
                          };
                          var descendentsHelper = function (v) {
                              return helper(d + 1 | 0)(v.offset)(v.tree.children);
                          };
                          var calculateLeftOffset = function (n) {
                              return ((100.0 - n) / 100.0) * totalWidth;
                          };
                          var rowWidth = calculateLeftOffset(Data_Foldable.foldr(Data_List_Types.foldableList)(function (v) {
                              return function (acc) {
                                  return acc + v.value.inherited.time;
                              };
                          })(0.0)(cs));
                          var annotateTree = function (v) {
                              return function (v1) {
                                  ...
                                  if (v1 instanceof Data_List_Types.Cons) {
                                      return new Data_List_Types.Cons({
                                          offset: v1.value0.offset + (v1.value0.tree.value.inherited.time / 100.0) * totalWidth,
                                          tree: v
                                      }, new Data_List_Types.Cons(v1.value0, v1.value1));
                                  };
                                  throw new Error("Failed pattern match at Profligate.FlameGraph (line 130, column 17 - line 130, column 110): " + [ v.constructor.name, v1.constructor.name ]);
                              };
                          };
  ...
  exports["displayStackInfo"] = displayStackInfo;
...
(function(exports) {
  ...
  var showStats = function (coords) {
                  return function (cs) {
                      ...
                      throw new Error("Failed pattern match at Profligate.TreeViz (line 200, column 9 - line 211, column 22): " + [ v1.constructor.name ]);
                  };
              };
              var getNewCoords = function (v1) {
                  return function (cs) {
                      var area = cs.inherited.time * 1.0e-2 * totalArea;
                      var newDirection = (function () {
                          var $93 = !(v1.width === 0.0) && area / v1.width > v1.width;
                          if ($93) {
                              return Horiz.value;
                          };
                          return Vert.value;
                      ...
                      var newHeight = (function () {
                          var newH = (function () {
                              var $94 = !horizontal || v1.width === 0.0;
                              if ($94) {
                                  return v1.height;
                              };
                      ...
                      var newWidth = (function () {
                          var newW = (function () {
                              var $96 = horizontal || v1.height === 0.0;
                              if ($96) {
                                  return v1.width;
                              };
                      ...
                      return function (v1) {
                          ...
                          var drawTitle = function (name) {
                              var spanAttrs = [ Halogen_HTML_Events.onClick(function (v2) {
                                  ...
                                  var $112 = Data_Eq.eq(Data_List_Types.eqList(Data_Eq.eqInt))(focus)(coords);
                                  if ($112) {
                                      return "name selected";
                                  };
                                  return "name";
                              })()) ];
                              var $113 = Data_List["null"](v1.children);
                              if ($113) {
  ...
  var showBisectoid = function (focus) {
                  return function (cs) {
                      var focusRing = (function () {
                          var v1 = getin(focus)(cs);
                          if (v1 instanceof Data_Maybe.Just) {
                              return [ Profligate_Util.rect([ Halogen_HTML_Properties.attr("x")(Data_Show.show(Data_Show.showNumber)(v1.value0.coords.x)), Halogen_HTML_Properties.attr("y")(Data_Show.show(Data_Show.showNumber)(v1.value0.coords.y)), Halogen_HTML_Properties.attr("width")(Data_Show.show(Data_Show.showNumber)(v1.value0.coords.width)), Halogen_HTML_Properties.attr("height")(Data_Show.show(Data_Show.showNumber)(v1.value0.coords.height)), Halogen_HTML_Properties.attr("stroke")("white"), Halogen_HTML_Properties.attr("stroke-width")("2"), Halogen_HTML_Properties.attr("fill")("none") ])([  ]) ];
                          };
                          if (v1 instanceof Data_Maybe.Nothing) {
                              return [  ];
                          };
                          throw new Error("Failed pattern match at Profligate.TreeViz (line 294, column 21 - line 305, column 26): " + [ v1.constructor.name ]);
                      })();
              ...
              var $$eval = function (v1) {
                  ...
                  if (v1 instanceof Uncollapse) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                          ...
                          for (var $156 in state) {
                              if ({}.hasOwnProperty.call(state, $156)) {
                                  $155[$156] = state[$156];
                              };
                          };
                          $155.costCenterStack = uncollapse(v1.value0)(state.costCenterStack);
                          $155.focus = v1.value0;
                          return $155;
                      }))(function (v2) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  ...
                  if (v1 instanceof Collapse) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                          ...
                          $159.costCenterStack = collapse(v1.value0)(state.costCenterStack);
                          $159.focus = v1.value0;
                          return $159;
                      }))(function (v2) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  ...
                  if (v1 instanceof Focus) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                          var $163 = {};
                          for (var $164 in state) {
                              if ({}.hasOwnProperty.call(state, $164)) {
                                  $163[$164] = state[$164];
                              };
                          };
                          $163.focus = v1.value0;
                  ...
                  throw new Error("Failed pattern match at Profligate.TreeViz (line 336, column 5 - line 336, column 66): " + [ v1.constructor.name ]);
              };
              var annotatedTree = function (dep) {
                  return function (coords) {
                      return function (cs) {
                          return Data_List.reverse(Data_Foldable.foldr(Data_List_Types.foldableList)(annotateTree(dep)(coords))(Data_List_Types.Nil.value)(Data_List.reverse(cs)));
                      };
                  };
              };
                      ...
                      return function (v2) {
                          return function (v3) {
                              if (v3 instanceof Data_List_Types.Nil) {
                                  var v4 = getNewCoords(v1)(v2.value);
                                  var newCoords = {
                                      x: v1.x,
                                      y: v1.y,
                                      width: v4.width,
                                  ...
                                  return new Data_List_Types.Cons({
                                      ...
                                      children: annotatedTree(depth + 1 | 0)(newCoords)(v2.children)
                                  }, Data_List_Types.Nil.value);
                              };
                              if (v3 instanceof Data_List_Types.Cons) {
                                  var horizontal = Data_Eq.eq(eqBisectoidDirection)(v3.value0.value.coords.direction)(Horiz.value);
                                  var newX = (function () {
                                      if (horizontal) {
                                          return v3.value0.value.coords.x;
                                      };
                                      return v3.value0.value.coords.x + v3.value0.value.coords.width;
                                  })();
                                  var newWidth = v1.width - (newX - v1.x);
                                  var newY = (function () {
                                      if (horizontal) {
                                          return v3.value0.value.coords.y + v3.value0.value.coords.height;
                                      };
                                      return v3.value0.value.coords.y;
                                  })();
                                  var newHeight = v1.height - (newY - v1.y);
                                  var newCoords = getNewCoords({
                                      x: newX,
                                      y: newY,
                                      width: newWidth,
                                      height: newHeight,
                                      direction: v3.value0.value.coords.direction
                                  })(v2.value);
                                  return new Data_List_Types.Cons({
                                      value: {
                              ...
                              throw new Error("Failed pattern match at Profligate.TreeViz (line 91, column 5 - line 91, column 136): " + [ depth.constructor.name, v1.constructor.name, v2.constructor.name, v3.constructor.name ]);
                          };
                      };
                  };
              };
              var startingTree = annotatedTree(0)({
                  x: 0.0,
                  y: 0.0,
                  width: 1000.0,
                  height: 1000.0,
      ...
      return function (dictMonadAff) {
          ...
          var showMain = function (v) {
              ...
              if (v.profFile instanceof Data_Maybe.Just) {
                  if (Data_Eq.eq(eqDisplayMode)(v.displayMode)(FlameGraph.value)) {
                      return [ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                          return "a";
                      }))(Data_Ord.ordUnit)(_a)(Data_Unit.unit)(Profligate_FlameGraph.flameGraph(dictMonadAff.MonadEffect0())(dictMonadAff)(v.profFile.value0))(Data_Unit.unit)(Data_Void.absurd) ];
                  };
                  if (Data_Eq.eq(eqDisplayMode)(v.displayMode)(TreeViz.value)) {
                      return [ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                          return "b";
                      }))(Data_Ord.ordUnit)(_b)(Data_Unit.unit)(Profligate_TreeViz.treeViz(dictMonadAff.MonadEffect0())(dictMonadAff)(v.profFile.value0))(Data_Unit.unit)(Data_Void.absurd) ];
                  };
              };
          ...
          var header = function (state) {
              return Halogen_HTML_Elements.header([ Halogen_HTML_Events.onDragOver(function (e) {
                  ...
                  return Data_Maybe.Just.create(new SetDisplayMode(FlameGraph.value));
              }), Halogen_HTML_Properties.attr("type")("radio"), Halogen_HTML_Properties.attr("name")("displayMode") ])((function () {
                  var $42 = Data_Eq.eq(eqDisplayMode)(state.displayMode)(FlameGraph.value);
                  if ($42) {
                      return [ Halogen_HTML_Properties.attr("checked")("checked") ];
                  };
                  return [  ];
              })())), Halogen_HTML_Elements.span([  ])([ Halogen_HTML_Core.text("Flame Grap") ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("dropzone") ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Plop yer .prof file here") ]) ]) ]);
          };
          var render = function (state) {
          ...
          var $$eval = (function () {
              ...
              return function (v) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_File_FileReader.result(v.value0)))(function (v1) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                              if (prof instanceof Data_Either.Left) {
                                  ...
                                  $50.parseError = new Data_Maybe.Just(prof.value0.value0);
                                  $50.profFile = Data_Maybe.Nothing.value;
                                  $50.loading = false;
                                  return $50;
                              };
                              if (prof instanceof Data_Either.Right) {
                                  ...
                                  $55.profFile = new Data_Maybe.Just({
                                  ...
                                  $55.parseError = Data_Maybe.Nothing.value;
                                  $55.loading = false;
                                  return $55;
                              };
                              throw new Error("Failed pattern match at Profligate.Component (line 189, column 17 - line 194, column 149): " + [ prof.constructor.name ]);
                          }))(function (v2) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          });
                      });
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(evt)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.stopPropagation(evt)))(function () {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                  ...
                                  $61.parseError = Data_Maybe.Nothing.value;
                                  $61.profFile = Data_Maybe.Nothing.value;
                                  $61.loading = true;
                                  return $61;
                              }))(function (v1) {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      ...
                                      throw new Error("Failed pattern match at Profligate.Component (line 209, column 13 - line 219, column 30): " + [ blob.constructor.name ]);
                                  })())(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                  });
                              });
                  ...
                  throw new Error("Failed pattern match at Profligate.Component (line 179, column 12 - line 220, column 22): " + [ v.constructor.name ]);
              };
          })();
          return Halogen_Component.mkComponent({
              initialState: Data_Function["const"](initialState),
