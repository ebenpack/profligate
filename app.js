...
(function(exports) {
  ...
  var filter = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Profligate.Profile.Profile (line 29, column 1 - line 29, column 59): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
      ...
      return function (dictMonadAff) {
          ...
          var render = function (state) {
              var flameGraph = (function () {
                  ...
                  throw new Error("Failed pattern match at Profligate.Component (line 75, column 13 - line 78, column 30): " + [ state.profFile.constructor.name ]);
              })();
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("container") ])([ header, Halogen_HTML_Elements.main_(flameGraph) ]);
          };
          var $$eval = (function () {
              ...
              return function (v) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_File_FileReader.result(v.value0)))(function (v1) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                              if (prof instanceof Data_Either.Left) {
                                  ...
                                  $39.parseError = new Data_Maybe.Just(prof.value0.value0);
                                  $39.profFile = Data_Maybe.Nothing.value;
                                  return $39;
                              };
                              if (prof instanceof Data_Either.Right) {
                                  ...
                                  $44.profFile = new Data_Maybe.Just({
                                  ...
                                  $44.parseError = Data_Maybe.Nothing.value;
                                  return $44;
                              };
                              throw new Error("Failed pattern match at Profligate.Component (line 91, column 17 - line 96, column 132): " + [ prof.constructor.name ]);
                          }))(function (v2) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      });
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(evt)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.stopPropagation(evt)))(function () {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                  ...
                                  $52.profFile = Data_Maybe.Nothing.value;
                                  return $52;
                              }))(function (v1) {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      ...
                                      throw new Error("Failed pattern match at Profligate.Component (line 110, column 13 - line 117, column 30): " + [ blob.constructor.name ]);
                                  })())(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                              });
                  ...
                  throw new Error("Failed pattern match at Profligate.Component (line 81, column 12 - line 118, column 22): " + [ v.constructor.name ]);
              };
          })();
