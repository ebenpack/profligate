...
(function(exports) {
  ...
  var eqBisectoidDirection = new Data_Eq.Eq(function (v) {
      return function (v1) {
          if (v instanceof Vert && v1 instanceof Vert) {
              return true;
          };
          if (v instanceof Horiz && v1 instanceof Horiz) {
              return true;
          };
          return false;
      };
  ...
  var showStats = function (coords) {
                      return function (cs) {
                          ...
                          throw new Error("Failed pattern match at Profligate.TreeViz (line 215, column 9 - line 226, column 22): " + [ v1.constructor.name ]);
                      };
                  };
                  var getCost = function (am) {
                      return function (cs) {
                          ...
                          throw new Error("Failed pattern match at Profligate.TreeViz (line 153, column 21 - line 155, column 36): " + [ am.constructor.name ]);
                      };
                  };
                  var getNewCoords = function (am) {
                      return function (v1) {
                          return function (cs) {
                              var area = getCost(am)(cs) * 1.0e-2 * totalArea;
                              var newDirection = (function () {
                                  var $106 = !(v1.width === 0.0) && area / v1.width > v1.width;
                                  if ($106) {
                                      return Horiz.value;
                                  };
                                  return Vert.value;
                              })();
                              var horizontal = Data_Eq.eq(eqBisectoidDirection)(newDirection)(Horiz.value);
                              var newHeight = (function () {
                                  var newH = (function () {
                                      var $107 = !horizontal || v1.width === 0.0;
                                      if ($107) {
                                          return v1.height;
                                      };
                                      return area / v1.width;
                                  })();
                                  var $108 = newH > 0.0;
                                  if ($108) {
                                      return newH;
                              ...
                              var newWidth = (function () {
                                  var newW = (function () {
                                      var $109 = horizontal || v1.height === 0.0;
                                      if ($109) {
                                          return v1.width;
                                      };
                                      return area / v1.height;
                                  })();
                                  var $110 = newW > 0.0;
                                  if ($110) {
                                      return newW;
  ...
  var reannotateTree = function (am) {
                      return function (coords) {
                          return function (cs) {
                              var reannotator = function (v1) {
                                  return function (v2) {
                                      return function (v3) {
                                          if (v3 instanceof Data_List_Types.Nil) {
                                              var v5 = getNewCoords(am)(v1)(v2.value.stack);
                                              var newCoords = {
                                                  x: v1.x,
                                                  y: v1.y,
                                                  width: v5.width,
                                              ...
                                              return new Data_List_Types.Cons({
                                                  value: {
                                                      coords: new Data_Maybe.Just(newCoords),
                                                      collapsed: v2.value.collapsed,
                                                      depth: v2.value.depth,
                                                      index: v2.value.index,
                                                      stack: v2.value.stack
                                                  },
                                                  children: reannotateTree(am)(newCoords)(v2.children)
                                              }, Data_List_Types.Nil.value);
                                          };
                                          if (v3 instanceof Data_List_Types.Cons) {
                                              var justCoords = Data_Maybe.fromMaybe({
                                                  x: 0.0,
                                                  y: 0.0,
                                                  width: 0.0,
                                                  height: 0.0,
                                                  direction: Horiz.value
                                              })(v3.value0.value.coords);
                                              var horizontal = Data_Eq.eq(eqBisectoidDirection)(justCoords.direction)(Horiz.value);
                                              var newX = (function () {
                                                  if (horizontal) {
                                                      return justCoords.x;
                                                  };
                                                  return justCoords.x + justCoords.width;
                                              })();
                                              var newWidth = v1.width - (newX - v1.x);
                                              var newY = (function () {
                                                  if (horizontal) {
                                                      return justCoords.y + justCoords.height;
                                                  };
                                                  return justCoords.y;
                                              })();
                                              var newHeight = v1.height - (newY - v1.y);
                                              var newCoords = getNewCoords(am)({
                                                  x: newX,
                                                  y: newY,
                                                  width: newWidth,
                                                  height: newHeight,
                                                  direction: justCoords.direction
                                              })(v2.value.stack);
                                              return new Data_List_Types.Cons({
                                                  value: {
                                                      coords: new Data_Maybe.Just(newCoords),
                                                  ...
                                                  children: reannotateTree(am)(newCoords)(v2.children)
                                              }, new Data_List_Types.Cons(v3.value0, v3.value1));
                                          };
                                          throw new Error("Failed pattern match at Profligate.TreeViz (line 363, column 9 - line 363, column 141): " + [ v1.constructor.name, v2.constructor.name, v3.constructor.name ]);
                                      };
                                  };
                              };
                              return Data_List.reverse(Data_Foldable.foldr(Data_List_Types.foldableList)(reannotator(coords))(Data_List_Types.Nil.value)(Data_List.reverse(cs)));
                          };
                      };
                  };
                          ...
                          return function (v1) {
                              ...
                              var drawTitle = function (name) {
                                  var spanAttrs = [ Halogen_HTML_Events.onClick(function (v2) {
                                      ...
                                      var $144 = Data_Eq.eq(Data_List_Types.eqList(Data_Eq.eqInt))(focus)(coords);
                                      if ($144) {
                                          return "name selected";
                                      };
                                      return "name";
                                  })()) ];
                                  var $145 = Data_List["null"](v1.children);
                                  if ($145) {
  ...
  var showTree = function (focus) {
                  ...
                  var showBisectoidHelper = function (focus) {
                      return function (treeCoords) {
                          return function (cs) {
                              var rowHelper = function (v1) {
                                  return function (acc) {
                                      return Data_Semigroup.append(Data_Semigroup.semigroupArray)(drawBisectoidView(focus)(Data_List.snoc(treeCoords)(v1.value.index))(v1))(acc);
                                  };
                              };
                  ...
                  var drawBisectoidView = function (focus) {
                      return function (currentCoords) {
                          return function (v1) {
                              var rest = (function () {
                                  ...
                                  return showBisectoidHelper(focus)(currentCoords)(v1.children);
                              })();
                              var drawBox = (function () {
                                  if (v1.value.coords instanceof Data_Maybe.Just) {
                                      return [ Profligate_Util.rect([ Halogen_HTML_Events.onClick(function (v2) {
                                          return new Data_Maybe.Just(new Focus(currentCoords));
                                      }), Halogen_HTML_Properties.attr("x")(Data_Show.show(Data_Show.showNumber)(v1.value.coords.value0.x)), Halogen_HTML_Properties.attr("y")(Data_Show.show(Data_Show.showNumber)(v1.value.coords.value0.y)), Halogen_HTML_Properties.attr("width")(Data_Show.show(Data_Show.showNumber)(v1.value.coords.value0.width)), Halogen_HTML_Properties.attr("height")(Data_Show.show(Data_Show.showNumber)(v1.value.coords.value0.height)), Halogen_HTML_Properties.attr("fill")(getColor(v1.value.stack)), Halogen_HTML_Properties.attr("data-thing")(v1.value.stack.name) ])([  ]) ];
                                  };
                                  if (v1.value.coords instanceof Data_Maybe.Nothing) {
                                      return [  ];
                                  };
                                  throw new Error("Failed pattern match at Profligate.TreeViz (line 342, column 13 - line 355, column 30): " + [ v1.value.coords.constructor.name ]);
                              })();
  ...
  var showBisectoid = function (focus) {
                  ...
                  var $$eval = function (v1) {
                      ...
                      if (v1 instanceof SetAnalysisMode) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                  ...
                                  $189.analysisMode = v1.value0;
                                  $189.costCenterStack = reannotateTree(v1.value0)({
                                      x: 0.0,
                                      y: 0.0,
                                      width: 1000.0,
                                      height: 1000.0,
                      ...
                      if (v1 instanceof Uncollapse) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                              var $193 = {};
                              for (var $194 in state) {
                                  if ({}.hasOwnProperty.call(state, $194)) {
                                      $193[$194] = state[$194];
                                  };
                              };
                              $193.costCenterStack = uncollapse(v1.value0)(state.costCenterStack);
                              $193.focus = v1.value0;
                              return $193;
                          }))(function (v2) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      ...
                      if (v1 instanceof Collapse) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                              ...
                              $197.costCenterStack = collapse(v1.value0)(state.costCenterStack);
                              $197.focus = v1.value0;
                              return $197;
                          }))(function (v2) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      ...
                      if (v1 instanceof Focus) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                              var $201 = {};
                              for (var $202 in state) {
                                  if ({}.hasOwnProperty.call(state, $202)) {
                                      $201[$202] = state[$202];
                                  };
                              };
                              $201.focus = v1.value0;
                      ...
                      throw new Error("Failed pattern match at Profligate.TreeViz (line 385, column 5 - line 385, column 66): " + [ v1.constructor.name ]);
                  };
                  var annotatedTree = function (am) {
                      return function (dep) {
                          return function (coords) {
                              return function (cs) {
                                  return Data_List.reverse(Data_Foldable.foldr(Data_List_Types.foldableList)(annotateTree(am)(dep)(coords))(Data_List_Types.Nil.value)(Data_List.reverse(cs)));
                              };
                          };
                      };
                  };
                  var annotateTree = function (am) {
                      return function (depth) {
                          return function (v1) {
                              return function (v2) {
                                  return function (v3) {
                                      if (v3 instanceof Data_List_Types.Nil) {
                                          var v4 = getNewCoords(am)(v1)(v2.value);
                                          var newCoords = {
                                              x: v1.x,
                                              y: v1.y,
                                              width: v4.width,
                                          ...
                                          return new Data_List_Types.Cons({
                                              ...
                                              children: annotatedTree(am)(depth + 1 | 0)(newCoords)(v2.children)
                                          }, Data_List_Types.Nil.value);
                                      };
                                      if (v3 instanceof Data_List_Types.Cons) {
                                          var justCoords = Data_Maybe.fromMaybe({
                                          ...
                                          return new Data_List_Types.Cons({
                                              value: {
                                                  index: v3.value0.value.index + 1 | 0,
                                                  depth: depth,
                                                  collapsed: true,
                                                  stack: v2.value,
                                                  coords: new Data_Maybe.Just(newCoords)
                                      ...
                                      throw new Error("Failed pattern match at Profligate.TreeViz (line 99, column 5 - line 99, column 152): " + [ am.constructor.name, depth.constructor.name, v1.constructor.name, v2.constructor.name, v3.constructor.name ]);
                                  };
                              };
                          };
                      };
  ...
  exports["treeViz"] = treeViz;
  exports["getColor"] = getColor;
  exports["eqBisectoidDirection"] = eqBisectoidDirection;
  ...
  var component = function (dictMonadEffect) {
      return function (dictMonadAff) {
          ...
          var showMain = function (v) {
              ...
              return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("text") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Introduction") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Profligate is a tool to help you visualize your GHC profile files like a pro... file.") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Just drop your .prof file (generated with the GHC RTS -p flag) up above, and " + ("profligate will produce a flame graph-style visualization of your program's cost-centre stacks to help you " + "analyze your program's performance.")) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("If you just want to try it out, "), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.attr("href")("hascheme.prof") ])([ Halogen_HTML_Core.text("there's a sample .prof file you can use here.") ]) ]) ]) ];
          };
          var initialState = {
