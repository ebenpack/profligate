...
(function(exports) {
  ...
  var ChangeFlameLegend = (function () {
      function ChangeFlameLegend(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeFlameLegend.create = function (value0) {
          return function (value1) {
              return new ChangeFlameLegend(value0, value1);
          };
      };
  ...
  var colors = [ "#B5D8EB", "#DCF7F3", "#E3AAD6", "#F5A2A2", "#F8DAFB", "#F9CDAD", "#FFBDD8", "#FFC8BA", "#FFD8D8", "#FFFCDD" ];
  var getColor = function (cs) {
      ...
      var idx = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(tot)(Data_Array.length(colors));
      var v = Data_Array.index(colors)(idx);
      if (v instanceof Data_Maybe.Just) {
          return v.value0;
      };
      return "red";
  };
  var drawCostCenter = function (rowHeight) {
      return function (offsetLeft) {
          return function (offsetTop) {
              return function (cs) {
                  ...
                  var height = Data_Show.show(Data_Show.showNumber)(rowHeight);
                  var eigthHeight = rowHeight * 0.8;
                  ...
                  var col = getColor(cs);
                  return g([ Halogen_HTML_Events.onMouseEnter(function (v) {
                      return Data_Maybe.Just.create(Halogen_Query.action(ChangeFlameLegend.create(new Data_Maybe.Just(cs))));
                  }), Halogen_HTML_Events.onMouseLeave(function (v) {
                      return Data_Maybe.Just.create(Halogen_Query.action(ChangeFlameLegend.create(Data_Maybe.Nothing.value)));
                  }), Halogen_HTML_Properties.attr("class")("stack") ])([ rect([ Halogen_HTML_Properties.attr("x")(x), Halogen_HTML_Properties.attr("y")(y), Halogen_HTML_Properties.attr("width")(width), Halogen_HTML_Properties.attr("height")(height), Halogen_HTML_Properties.attr("fill")(col), Halogen_HTML_Properties.attr("stroke-width")(Data_Show.show(Data_Show.showInt)(strokeWidth)) ])([ title([  ])([ text([  ])([ Halogen_HTML_Core.text(displayStackInfo(cs)) ]) ]) ]), foreignObject([ Halogen_HTML_Properties.attr("x")(x), Halogen_HTML_Properties.attr("y")(y), Halogen_HTML_Properties.attr("width")(width), Halogen_HTML_Properties.attr("height")(height), Halogen_HTML_Properties.attr("pointer-events")("none") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("style")("font-size:" + (Data_Show.show(Data_Show.showNumber)(rowHeight * 0.7) + ("px;height" + (height + ";")))), Halogen_HTML_Properties.attr("pointer-events")("none") ])([ Halogen_HTML_Core.text(cs.name) ]) ]) ]);
              };
          };
      };
  };
      ...
      return function (dictMonadAff) {
          return function (prof) {
              var showFlameLegend = function (cs) {
                  ...
                  return text([ Halogen_HTML_Properties.attr("y")(Data_Show.show(Data_Show.showNumber)(30.0 * 2.0)), Halogen_HTML_Properties.attr("x")(Data_Show.show(Data_Show.showNumber)(totalWidth * 2.0e-2)), Halogen_HTML_Properties.attr("font-size")(Data_Show.show(Data_Show.showNumber)(30.0)) ])([ Halogen_HTML_Core.text(t) ]);
              };
              var initialState = {
                  currentId: 0,
              ...
              var $$eval = function (v) {
                  ...
                  throw new Error("Failed pattern match at Profligate.FlameGraph (line 90, column 9 - line 90, column 59): " + [ v.constructor.name ]);
              };
                  ...
                  return function (baseOffset) {
                      return function (cs) {
                          ...
                          var rowHelper = function (v) {
                              return function (acc) {
                                  return Data_Array.cons(drawCostCenter(30.0)(v.offset)(offsetTop)(v.tree.value))(acc);
                              };
                          };
                          ...
                          var annotateTree = function (v) {
                              return function (v1) {
                                  if (v1 instanceof Data_List_Types.Nil) {
                                      var $35 = v.value.inherited.time > 0.0 || v.value.inherited.alloc > 0.0;
                                      if ($35) {
                                          return new Data_List_Types.Cons({
                                              offset: baseOffset,
                                              tree: v
                                  ...
                                  if (v1 instanceof Data_List_Types.Cons) {
                                      var $37 = v.value.inherited.time > 0.0 || v.value.inherited.alloc > 0.0;
                                      if ($37) {
                                          return new Data_List_Types.Cons({
                                      ...
                                      return new Data_List_Types.Cons(v1.value0, v1.value1);
                                  };
                                  throw new Error("Failed pattern match at Profligate.FlameGraph (line 126, column 17 - line 126, column 110): " + [ v.constructor.name, v1.constructor.name ]);
                              };
                          };
  ...
  exports["drawCostCenter"] = drawCostCenter;
  exports["svg"] = svg;
  exports["rect"] = rect;
  exports["text"] = text;
  exports["title"] = title;
...
(function(exports) {
  ...
  var ChangeDisplayMode = (function () {
      function ChangeDisplayMode(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeDisplayMode.create = function (value0) {
          return function (value1) {
              return new ChangeDisplayMode(value0, value1);
          };
      };
  ...
  exports["DragOver"] = DragOver;
  exports["ChangeDisplayMode"] = ChangeDisplayMode;
  exports["NoOp"] = NoOp;
})(PS["Profligate.State"] = PS["Profligate.State"] || {});
(function(exports) {
    "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  ...
  var Profligate_State = PS["Profligate.State"];
  var Text_Parsing_StringParser = PS["Text.Parsing.StringParser"];
  var Web_Event_Event = PS["Web.Event.Event"];
  var Web_Event_EventTarget = PS["Web.Event.EventTarget"];
  var Web_File_Blob = PS["Web.File.Blob"];
  ...
  var Web_HTML_Event_DataTransfer = PS["Web.HTML.Event.DataTransfer"];
  var Web_HTML_Event_DragEvent = PS["Web.HTML.Event.DragEvent"];                 
  var FlameGraphSlot = (function () {
      function FlameGraphSlot() {

      };
      FlameGraphSlot.value = new FlameGraphSlot();
      return FlameGraphSlot;
  })();
  ...
  var component = function (dictMonadEffect) {
      return function (dictMonadAff) {
          ...
          var initialState = {
              ...
              displayMode: Profligate_State.FlameGraph.value,
              loading: false
          };
          var header = Halogen_HTML_Elements.header([ Halogen_HTML_Events.onDragOver(function (e) {
              return Data_Maybe.Just.create(Halogen_Query.action(Profligate_State.DragOver.create(e)));
          }), Halogen_HTML_Events.onDrop(function (e) {
              return Data_Maybe.Just.create(Halogen_Query.action(Profligate_State.UploadFile.create(e)));
          }) ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Profligate") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("dropzone") ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Plop yer .prof file here") ]) ]) ]);
          var render = function (state) {
              var flameGraph = (function () {
                  if (state.profFile instanceof Data_Maybe.Just) {
                      return [ Halogen_HTML.slot(FlameGraphSlot.value)(Profligate_FlameGraph.flameGraph(dictMonadAff.MonadEffect0())(dictMonadAff)(state.profFile.value0))(Data_Unit.unit)(Data_Void.absurd) ];
                  };
                  if (state.profFile instanceof Data_Maybe.Nothing) {
                      return [  ];
                  };
                  throw new Error("Failed pattern match at Profligate.Component (line 79, column 13 - line 82, column 30): " + [ state.profFile.constructor.name ]);
              })();
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("container") ])([ header, (function () {
                  if (state.loading) {
                      return Profligate_Spinner.spinner;
                  };
                  return Halogen_HTML_Elements.main_(flameGraph);
              })() ]);
          };
          var $$eval = (function () {
              var bindLoad = function (trgt) {
                  return function (f) {
                      return function __do() {
                          var v = Web_Event_EventTarget.eventListener(f)();
                          return Web_Event_EventTarget.addEventListener("load")(v)(false)(trgt)();
                      };
                  };
              };
              var subthingy = function (trgt) {
                  return function (fr) {
                      var handleLoad = function (e) {
                          return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(Profligate_State.FileLoaded.create(fr)(Halogen_Query_EventSource.Done.value));
                      };
                      return Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource.eventSource(dictMonadAff)(bindLoad(trgt))(handleLoad));
                  };
              };
              return function (v) {
                  if (v instanceof Profligate_State.NoOp) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  };
                  if (v instanceof Profligate_State.ChangeDisplayMode) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                          var $37 = {};
                          for (var $38 in state) {
                          ...
                          $37.displayMode = v.value0;
                          return $37;
                      }))(function (v1) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  };
                  if (v instanceof Profligate_State.FileLoaded) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                  ...
                                  if (prof instanceof Data_Either.Right) {
                                      var filteredCostCenterStack = Profligate_Profile_Profile.filter(function (v3) {
                                          return v3.inherited.time > 0.0 || v3.inherited.alloc > 0.0;
                                  ...
                                  throw new Error("Failed pattern match at Profligate.Component (line 96, column 17 - line 101, column 132): " + [ prof.constructor.name ]);
                              }))(function (v3) {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                              });
                          });
                  ...
                  if (v instanceof Profligate_State.DragOver) {
                  ...
                  if (v instanceof Profligate_State.UploadFile) {
                      var evt = Web_HTML_Event_DragEvent.toEvent(v.value0);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(evt)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.stopPropagation(evt)))(function () {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                  ...
                                  $60.parseError = Data_Maybe.Nothing.value;
                                  $60.profFile = Data_Maybe.Nothing.value;
                                  return $60;
                              }))(function (v1) {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                          ...
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_File_FileReader.fileReader))(function (v2) {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                                  ...
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(subthingy(et)(v2))(function () {
                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_File_FileReader.readAsText(blob.value0)(v2)))(function (v4) {
                                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                                      });
                                                  });
                                              });
                                      ...
                                      throw new Error("Failed pattern match at Profligate.Component (line 116, column 13 - line 125, column 30): " + [ blob.constructor.name ]);
                                  })())(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                              });
                  ...
                  throw new Error("Failed pattern match at Profligate.Component (line 85, column 12 - line 126, column 22): " + [ v.constructor.name ]);
              };
          })();
  ...
  exports["FlameGraphSlot"] = FlameGraphSlot;
  exports["component"] = component;
